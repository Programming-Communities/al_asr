...
export const metadata = {
  ...
  description: "Al Asr Hussaini Calendar - Islamic Services, Calendar Events, and Community Programs",
  ...
  openGraph: {
    ...
    type: "website",
    locale: "ur_PK",
    siteName: "Al Asr Hussaini Calendar",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  return (
    <html lang="ur" suppressHydrationWarning className="scroll-smooth">
      <head>
        ...
        <meta property="og:description" content="Islamic Services, Calendar Events, and Community Programs" />
        <meta property="og:image" content="https://al-asr.centers.pk/og-image.jpg" />
